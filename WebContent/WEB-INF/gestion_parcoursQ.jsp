...
<fieldset>
 ...
 <table border="1" cellpadding="5" cellspacing="5">
    ...
    <c:if test="${currentPage != 1}">
        <td><a href="gestion_parcoursQ?page=${currentPage - 1}">Previous</a></td>
    </c:if>
        ...
        <tr>
            <c:forEach begin="1" end="${noOfPages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <td><a href="gestion_parcoursQ?page=${i}">${i}</a></td>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
        </tr>
    ...
    <c:if test="${currentPage lt noOfPages}">
        <td><a href="gestion_parcoursQ?page=${currentPage + 1}">Next</a></td>
    </c:if>
